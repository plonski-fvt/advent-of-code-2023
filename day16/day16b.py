...
def compute_num_energized(lasers_to_process):
...
west_lava_sums = [compute_num_energized([LaserBeam(row, 0, Direction.east)]) for row in range(rows)]
print(max(west_lava_sums))
east_lava_sums = [compute_num_energized([LaserBeam(row, cols - 1, Direction.west)]) for row in range(rows)]
print(max(east_lava_sums))
north_lava_sums = [compute_num_energized([LaserBeam(0, col, Direction.south)]) for col in range(cols)]
print(max(north_lava_sums))
south_lava_sums = [compute_num_energized([LaserBeam(rows - 1, col, Direction.north)]) for col in range(cols)]
print(max(south_lava_sums))